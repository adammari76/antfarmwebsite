        ...
        <div class="container">
            ...
            <div class="portfolio-grid">
                <article class="portfolio-item reveal-up">
                    <div class="portfolio-image" role="img" aria-label="Corporate website design project preview for a consulting company in Zimbabwe"></div>
                ...
                <article class="portfolio-item reveal-up">
                    <div class="portfolio-image" role="img" aria-label="Ecommerce store project preview for a Harare-based retail business"></div>
                    <div class="portfolio-body">
                ...
                <article class="portfolio-item reveal-up">
                    <div class="portfolio-image" role="img" aria-label="Professional service website redesign project preview"></div>
                    <div class="portfolio-body">
                ...
                <article class="portfolio-item reveal-up">
                    <div class="portfolio-image" role="img" aria-label="Booking and inquiry website project preview"></div>
                    <div class="portfolio-body">
                ...
                <article class="portfolio-item reveal-up">
                    <div class="portfolio-image" role="img" aria-label="Hospitality brand website design project preview"></div>
                    <div class="portfolio-body">
                ...
                <article class="portfolio-item reveal-up">
                    <div class="portfolio-image" role="img" aria-label="Operations dashboard and software interface project preview"></div>
                    <div class="portfolio-body">
        ...
        <div class="container">
            <div class="cta-panel reveal-up">
                <div class="row align-items-center g-4">
                    <div class="col-lg-8">
                        <p class="section-label mb-2">Your Project Next</p>
                        <h2 class="mb-3">Ready to launch a premium digital experience for your business?</h2>
